...
const HomeScreen = () => {
 ...
 const onChange = (nativeEvent) =>{
      ...
      let items = fetchData?.allCarts?.filter(item=>item?.email === name.result.email)
...
{/* <Swiper style={styles.wrapper} showsButtons={true}>
    ...
    <View style={styles.page}>
      ...
      <FlatList
        data={items}
        renderItem={({ item }) => <RestaurantItem order={item.invoiceData} item={item}/>}
